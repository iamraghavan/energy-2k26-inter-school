  ...
  return <main className="display-page">
    ...
    <section className="display-grid">
      <article className="featured-panel">
        {featured ? <><div className="eyebrow"><span>FEATURED MATCH</span><span className="live-pill"><i/>LIVE</span></div><div className="featured-title"><span>{sportName(featured.sport)}</span><small>{featured.gender.toUpperCase()} · {featured.venue}</small></div><Score match={featured}/></> : <div className="empty-state"><CalendarClock/><h2>No live matches</h2><p>The next fixture will appear here automatically.</p></div>}
      </article>
